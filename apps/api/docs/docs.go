...
const docTemplate = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.DaycarePreviewResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.ExtracurricularPreviewResponse"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/dto.IncomeCategoryResponse"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateIncomeCategoryRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/income-transactions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Filter by income category ID",
        ...
        "/v1/students/{id}/extracurriculars/{se_id}/billing-exclusions": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.BillingExclusionsResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Daftar bulan skip",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.SetBillingExclusionsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/students/{id}/facilities/{facilityId}/billing-exclusions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Student Facility ID",
                        "name": "facilityId",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "dto.CreateIncomeCategoryRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "dto.DaycarePreviewItem": {
            "type": "object",
            "properties": {
                "category": {
                    "description": "premium | regular",
                    "type": "string"
                },
                "reason": {
                    "type": "string"
        ...
        "dto.DaycarePreviewResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.DaycarePreviewItem"
                    }
                },
                "total_enrollments": {
                    "type": "integer"
        ...
        "dto.ExtracurricularPreviewItem": {
            "type": "object",
            "properties": {
                "extracurricular_id": {
                    "type": "integer"
                ...
                "months_to_add": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.MonthYearBrief"
                    }
                },
                "skipped_excluded": {
                    "type": "integer"
        ...
        "dto.ExtracurricularPreviewResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.ExtracurricularPreviewItem"
                    }
                },
                "total_enrollments": {
                    "type": "integer"
        ...
        "dto.IncomeCategoryBriefResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "dto.IncomeTransactionResponse": {
            ...
            "properties": {
                ...
                "income_category": {
                    "$ref": "#/definitions/dto.IncomeCategoryBriefResponse"
                },
                "notes": {
                    "type": "string"
                },
        ...
        "dto.SetBillingExclusionsRequest": {
            "type": "object",
            "properties": {
                "months": {
                    "type": "array",
