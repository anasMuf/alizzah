...
export type postV1AcademicEventsPromotionsPreviewResponseSuccess = (postV1AcademicEventsPromotionsPreviewResponse200) & {
  headers: Headers;
};
export type postV1AcademicEventsPromotionsPreviewResponseError = (postV1AcademicEventsPromotionsPreviewResponse400 | postV1AcademicEventsPromotionsPreviewResponse401 | postV1AcademicEventsPromotionsPreviewResponse403 | postV1AcademicEventsPromotionsPreviewResponse500) & {
  headers: Headers;
};

export type postV1AcademicEventsPromotionsPreviewResponse = (postV1AcademicEventsPromotionsPreviewResponseSuccess | postV1AcademicEventsPromotionsPreviewResponseError)
 ...
 */
export const postV1AcademicEventsPromotionsPreview = async (dtoPromotionRequest: DtoPromotionRequest, options?: RequestInit): Promise<postV1AcademicEventsPromotionsPreviewResponse> => {

  return customInstance<postV1AcademicEventsPromotionsPreviewResponse>(getPostV1AcademicEventsPromotionsPreviewUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getPostV1AcademicEventsPromotionsPreviewMutationOptions = <TError = DtoErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1AcademicEventsPromotionsPreview>>, TError,{data: DtoPromotionRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1AcademicEventsPromotionsPreview>>, TError,{data: DtoPromotionRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1AcademicEventsPromotionsPreview>>, {data: DtoPromotionRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostV1AcademicEventsPromotionsPreviewMutationResult = NonNullable<Awaited<ReturnType<typeof postV1AcademicEventsPromotionsPreview>>>
    export type PostV1AcademicEventsPromotionsPreviewMutationBody = DtoPromotionRequest
    export type PostV1AcademicEventsPromotionsPreviewMutationError = DtoErrorResponse

    /**
 * @summary Preview promotion results (dry run)
 */
export const usePostV1AcademicEventsPromotionsPreview = <TError = DtoErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1AcademicEventsPromotionsPreview>>, TError,{data: DtoPromotionRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getPostV1AcademicEventsPromotionsPreviewMutationOptions(options), queryClient);
    }
