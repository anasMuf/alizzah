 ...
 */
export const postV1KoperasiProducts = async (barangCreateRequest: BarangCreateRequest, options?: RequestInit): Promise<postV1KoperasiProductsResponse> => {
...
export const getPostV1KoperasiProductsMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiProducts>>, TError,{data: BarangCreateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiProducts>>, TError,{data: BarangCreateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1KoperasiProducts>>, {data: BarangCreateRequest}> = (props) => {
          const {data} = props ?? {};
...
export const putV1KoperasiProductsId = async (id: number,
    barangCreateRequest: BarangCreateRequest, options?: RequestInit): Promise<putV1KoperasiProductsIdResponse> => {
...
export const getPutV1KoperasiProductsIdMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putV1KoperasiProductsId>>, TError,{id: number;data: BarangCreateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof putV1KoperasiProductsId>>, TError,{id: number;data: BarangCreateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof putV1KoperasiProductsId>>, {id: number;data: BarangCreateRequest}> = (props) => {
          const {id,data} = props ?? {};
