...
import type {
  ...
  PenjualanCreateRequest,
  PenjualanPaymentRequest,
 ...
 */
export const postV1KoperasiSales = async (penjualanCreateRequest: PenjualanCreateRequest, options?: RequestInit): Promise<postV1KoperasiSalesResponse> => {
...
export const getPostV1KoperasiSalesMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiSales>>, TError,{data: PenjualanCreateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiSales>>, TError,{data: PenjualanCreateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1KoperasiSales>>, {data: PenjualanCreateRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostV1KoperasiSalesMutationBody = PenjualanCreateRequest
...
export const postV1KoperasiSalesIdPayments = async (id: number,
    penjualanPaymentRequest: PenjualanPaymentRequest, options?: RequestInit): Promise<postV1KoperasiSalesIdPaymentsResponse> => {
...
export const getPostV1KoperasiSalesIdPaymentsMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiSalesIdPayments>>, TError,{id: number;data: PenjualanPaymentRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiSalesIdPayments>>, TError,{id: number;data: PenjualanPaymentRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1KoperasiSalesIdPayments>>, {id: number;data: PenjualanPaymentRequest}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostV1KoperasiSalesIdPaymentsMutationBody = PenjualanPaymentRequest
...
export const usePostV1KoperasiSalesIdPayments = <TError = unknown,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {id: number;data: PenjualanPaymentRequest},
        TContext
      > => {
