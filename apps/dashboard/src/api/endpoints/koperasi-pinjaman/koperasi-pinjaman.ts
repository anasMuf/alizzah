 ...
 */
export const postV1KoperasiLoans = async (pinjamanCreateRequest: PinjamanCreateRequest, options?: RequestInit): Promise<postV1KoperasiLoansResponse> => {
...
export const getPostV1KoperasiLoansMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiLoans>>, TError,{data: PinjamanCreateRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiLoans>>, TError,{data: PinjamanCreateRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1KoperasiLoans>>, {data: PinjamanCreateRequest}> = (props) => {
          const {data} = props ?? {};
...
export const postV1KoperasiLoansIdPayments = async (id: number,
    pinjamanPaymentRequest: PinjamanPaymentRequest, options?: RequestInit): Promise<postV1KoperasiLoansIdPaymentsResponse> => {
...
export const getPostV1KoperasiLoansIdPaymentsMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiLoansIdPayments>>, TError,{id: number;data: PinjamanPaymentRequest}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postV1KoperasiLoansIdPayments>>, TError,{id: number;data: PinjamanPaymentRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postV1KoperasiLoansIdPayments>>, {id: number;data: PinjamanPaymentRequest}> = (props) => {
          const {id,data} = props ?? {};
