 ...
 */
import type { InternalModulesKoperasiBarangVariantRequest } from "./internalModulesKoperasiBarangVariantRequest";

export interface InternalModulesKoperasiBarangCreateRequest {
	/** @maxLength 50 */
	category?: string;
	/**
  ...
  dipakai untuk membuat/memperbarui satu varian "Default" (kompatibilitas form lama). */
	variants?: InternalModulesKoperasiBarangVariantRequest[];
}
