		...
		<div className="space-y-6">
			<div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
				...
				<div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 relative overflow-hidden flex flex-col">
					...
					<p className="text-3xl font-bold text-gray-900 relative z-10 mb-2">
						{summary
							? formatRupiah(summary.savings_general_balance)
							: formatRupiah(0)}
					</p>
					<p className="text-sm text-gray-500 relative z-10">
				...
				<div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 relative overflow-hidden">
					...
					<p className="text-3xl font-bold text-gray-900 relative z-10 mb-2">
						{summary
							? formatRupiah(summary.savings_mandatory_balance)
							: formatRupiah(0)}
					</p>
					<p className="text-sm text-gray-500 relative z-10">
						Hanya bisa ditarik saat kelulusan atau mutasi.
					</p>
				</div>
			</div>
				...
				<div className="flex">
					<div className="ml-3">
						...
						<div className="mt-2 text-sm text-blue-700">
							<p>
								Tab keuangan ini hanya berupa ringkasan *read-only*. Untuk
								melakukan pencatatan pembayaran tagihan, penarikan/setoran
								tabungan, silakan akses melalui modul <strong>Keuangan</strong>.
							</p>
						</div>
					</div>
				</div>
