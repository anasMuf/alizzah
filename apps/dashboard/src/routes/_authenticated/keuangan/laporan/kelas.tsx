    ...
    <div className="space-y-6">
        ...
        <>
          ...
          <div className="flex items-center gap-2 print:hidden">
            ...
            {['', 'unpaid', 'paid'].map((val) => (
              ...
              >
                {val === '' ? 'Semua' : val === 'paid' ? 'Lunas' : 'Belum Lunas'}
              </button>
            ))}
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="py-3.5 pl-6 pr-3 text-left text-sm font-semibold text-gray-900 w-12">#</th>
                    <th className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Nama</th>
                    <th className="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">Tagihan</th>
                    <th className="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">Dibayar</th>
                    <th className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900 pr-6">Status</th>
                  </tr>
                </thead>
      ...
      {shouldFetch && !isLoading && !isError && !report && (
        <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-12 text-center">
          <p className="text-sm text-gray-500">Tidak ada data untuk kelas dan periode ini.</p>
        </div>
      )}
    </div>
  );
