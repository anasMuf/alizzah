...
function TagihanSiswaPage() {
  ...
  if (isStudentLoading) return <div className="p-8 text-center text-gray-500">Memuat profil siswa...</div>;
      ...
      <div className="border-b border-gray-200 pb-5 sm:flex sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            {student.nisn ? `NISN: ${student.nisn}` : 'Belum ada NISN'} &bull; {student.active_enrollment?.class_group?.name || 'Tanpa Rombel'} &bull; Tahun Ajaran: {activeAy?.name}
          </p>
        </div>
